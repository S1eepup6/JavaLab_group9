...
public class MultiServer {
    ...
    public MultiServer(){
       globalMap = new HashMap<String,HashMap<String, ServerRecThread>>();
        ...
        globalMap.put("윤희용1",group01);
        globalMap.put("윤희용2",group02);
        globalMap.put("윤희용3",group03);
        globalMap.put("윤희용4",group04);
        globalMap.put("윤희용5",group05);
        globalMap.put("윤희용6",group06);
        globalMap.put("윤희용7",group07);
    }//생성자----
    public void init(){
        try{
